        ...
        AndroidView(
            ...
            update = { inputView ->
                ...
                if (!inputView.hasFocus()) {
                    ...
                    val imm = inputView.context.getSystemService(Context.INPUT_METHOD_SERVICE)
        ...
        Canvas(
            ...
            for (row in 0 until snapshot.rows) {
                ...
                for (col in 0 until snapshot.columns) {
                    ...
                    val fg = cell.foreground.toComposeColor().let {
                        if (cell.dim) it.copy(alpha = 0.7f) else it
                    }
